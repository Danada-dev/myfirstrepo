...
float add_float(float a_int, float b_int);
float subtract_float(float a_int, float b_int);
float multiply_float(float a_int, float b_int);
float divide_float(float a_int, float b_int);
